...
MAX_CHAT_SESSIONS = get_int_env("MAX_CHAT_SESSIONS", 2)

# Performance
AUTH_TOKEN_CACHE_TTL_SECONDS = get_int_env("AUTH_TOKEN_CACHE_TTL_SECONDS", 600)
DASHBOARD_STORE_CACHE_TTL_SECONDS = get_int_env("DASHBOARD_STORE_CACHE_TTL_SECONDS", 120)
SLOW_REQUEST_LOG_THRESHOLD_MS = get_int_env("SLOW_REQUEST_LOG_THRESHOLD_MS", 800)
...
# Auth cookies
AUTH_ACCESS_COOKIE_NAME = os.getenv("AUTH_ACCESS_COOKIE_NAME", "dt_access_token")
AUTH_REFRESH_COOKIE_NAME = os.getenv("AUTH_REFRESH_COOKIE_NAME", "dt_refresh_token")
AUTH_COOKIE_PATH = os.getenv("AUTH_COOKIE_PATH", "/")
AUTH_COOKIE_DOMAIN = os.getenv("AUTH_COOKIE_DOMAIN", "").strip() or None
AUTH_COOKIE_SAMESITE = os.getenv("AUTH_COOKIE_SAMESITE", "Lax")
AUTH_COOKIE_SECURE = get_bool_env("AUTH_COOKIE_SECURE", HTTPS_ENABLED)
AUTH_ACCESS_COOKIE_MAX_AGE_SECONDS = get_int_env("AUTH_ACCESS_COOKIE_MAX_AGE_SECONDS", 60 * 60 * 12)
AUTH_REFRESH_COOKIE_MAX_AGE_SECONDS = get_int_env("AUTH_REFRESH_COOKIE_MAX_AGE_SECONDS", 60 * 60 * 24 * 30)
